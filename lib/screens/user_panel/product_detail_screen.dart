...
import 'package:shop_mate/controllers/product_rating_controller.dart';
import 'package:shop_mate/models/cart_model.dart';
import 'package:shop_mate/models/product_model.dart';
import 'package:shop_mate/models/review_model.dart';
...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ProductRatingController productRatingController =
        Get.put(ProductRatingController(widget.productModel.productId));
    return Scaffold(
      appBar: AppBar(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Container(
                            ...
                            child: RatingBar.builder(
                              ...
                              initialRating: double.parse(
                                  productRatingController.averageRating
                                      .toString()),
                              minRating: 1,
                          ...
                          Text(
                            productRatingController.averageRating.toString(),
                          ),
                        ],
                      ),
  ...
  static Future<void> sendMessageOnWhatsApp(ProductModel productModel) async {
    const number = '+917027184135';
    final message =
        'Hello My Boss !\nCheck out this amazing product available on the Shop Mate app:\n'
        '🛍 Product Name: ${productModel.productName}\n'
        '💲 Price: ₹${productModel.fullPrice}\n'
        '📸 Image: ${productModel.productImages[0]}\n\n'
        'Order now on the Shop Mate app and get it delivered to your doorstep!\n'
